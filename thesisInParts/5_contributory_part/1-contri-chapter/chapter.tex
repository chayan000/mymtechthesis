 ...
 This chapter describes the lab setup we created for fault injection experiments using the ChipWhisperer platform. ChipWhisperer is a well-known tool among security researchers and professionals, offering a solid set of features for side-channel analysis and glitch-based fault injection. What makes it stand out is how it brings together hardware and software into one smooth, easy-to-control system for running experiments.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth, height=0.5\linewidth]{/home/cp07/mymtechthesis/thesisInParts/images/CWNANO.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth, height=0.5\linewidth]{/home/cp07/mymtechthesis/thesisInParts/images/CWLITE.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth, height=0.5\linewidth]{/home/cp07/mymtechthesis/thesisInParts/images/cwlitw_2_part.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth, height=0.5\linewidth]{/home/cp07/mymtechthesis/thesisInParts/images/cwhuskyannoted.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{/home/cp07/mymtechthesis/thesisInParts/images/executable file.png}
